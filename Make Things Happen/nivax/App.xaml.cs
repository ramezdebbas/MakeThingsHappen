...
using FoodVariable.SettingsFlyouts;
    ...
    sealed partial class App : Application
    {
        ...
        protected async override void OnSearchActivated(Windows.ApplicationModel.Activation.SearchActivatedEventArgs args)
        {
            ...
            if (frame == null)
            {
                ...
                frame = new Frame();
                FoodVariable.Common.SuspensionManager.RegisterFrame(frame, "AppFrame");
                ...
                if (args.PreviousExecutionState == ApplicationExecutionState.Terminated)
                {
                    ...
                    try
                    {
                        await FoodVariable.Common.SuspensionManager.RestoreAsync();
                    }
                    catch (FoodVariable.Common.SuspensionManagerException)
                    {
